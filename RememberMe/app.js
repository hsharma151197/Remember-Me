// Model
  ...
  function setDataToStorage(object){
...
function getDataFromStorage(keysArray)
{
 // Read it using the storage API
 chrome.storage.sync.get(keysArray, function(items) {
        ...
        addItem: function(typ, tit, des){
            ...
            if(typ === 'one'){
                ...
                getCurrentTabUrl(function(url){
                    ...
                    setDataToStorage({one: data.allNotes.one});
                })
